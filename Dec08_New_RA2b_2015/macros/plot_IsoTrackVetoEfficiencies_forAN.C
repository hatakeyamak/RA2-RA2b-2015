...
void plot_IsoTrackVetoEfficiencies_forAN(std::string elogForPlot=""){
  ...
  thist->GetXaxis()->SetTitle("Search bin");
  thist->SetMarkerStyle(20);
  thist->Draw();

  
  TLatex * ttext1 = new TLatex(4.0 , ytext , "4 #leq N_{jets} #leq 6");
