...
//      temp_tt->SetMaximum(maxVal);
      ...
      // TLegend
      sprintf(tempname,"%s",trigName.c_str());
 ...
 */
 	  ...
 	  TH1D Hpass = (TH1D) (* temp_tt);
	  TH1D Hall = (TH1D) (* temp_tt);
	  
	  TH1D dumH("dum","dum",temp_tt->GetNbinsX(),0,temp_tt->GetXaxis()->GetXmax());
	  dumH.Fill(0);
	  dumH.GetXaxis()->SetTitle("Dummy");
	  dumH.GetXaxis()->SetTitleSize(1);
	  dumH.GetXaxis()->SetLabelSize(10);
	  dumH.Draw("same");

		
      TEfficiency * pEff = new TEfficiency( Hpass, Hall);

	  Hall.GetXaxis()->SetLabelFont(42);
      Hall.GetXaxis()->SetLabelOffset(0.007);
      Hall.GetXaxis()->SetLabelSize(0.04);
      Hall.GetXaxis()->SetTitleSize(0.05);
      Hall.GetXaxis()->SetTitleOffset(0.9);
      Hall.GetXaxis()->SetTitleFont(42);
      Hall.GetYaxis()->SetLabelFont(42);
      Hall.GetYaxis()->SetLabelOffset(0.007);
      Hall.GetYaxis()->SetLabelSize(0.04);
      Hall.GetYaxis()->SetTitleSize(0.05);
      Hall.GetYaxis()->SetTitleOffset(1.0);
      Hall.GetYaxis()->SetTitleFont(42);
	  
	  Hpass.GetXaxis()->SetLabelFont(42);
      Hpass.GetXaxis()->SetLabelOffset(0.007);
      Hpass.GetXaxis()->SetLabelSize(0.04);
      Hpass.GetXaxis()->SetTitleSize(0.05);
      Hpass.GetXaxis()->SetTitleOffset(0.9);
      Hpass.GetXaxis()->SetTitleFont(42);
      Hpass.GetYaxis()->SetLabelFont(42);
      Hpass.GetYaxis()->SetLabelOffset(0.007);
      Hpass.GetYaxis()->SetLabelSize(0.04);
      Hpass.GetYaxis()->SetTitleSize(0.05);
      Hpass.GetYaxis()->SetTitleOffset(1.0);
      Hpass.GetYaxis()->SetTitleFont(42);
...
//      if(it->first!="NoTrig") denominator->Draw("same");
      pEff->Draw("same");
	  gPad->Update();
	  //pEff->GetPaintedGraph()->GetXaxis()->SetTitle("fafsfjflkshfkshflkkhfslhhfksdflkshf");
	  //gPad->Update();
	 
	 Hall.GetXaxis()->SetLabelSize(.1);
