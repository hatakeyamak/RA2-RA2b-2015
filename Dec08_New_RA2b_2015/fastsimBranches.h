...
// Sat Nov 14 18:47:01 2015 by ROOT version 5.34/22
// from TTree tree/all observables, T1bbbb_mMother-2000_mLSP-1050_fast
// found on file: /data3/store/user/hatake/ntuples/SusyRA2Analysis2015/Run2ProductionV4/scan/T1bbbb_mMother-2000_mLSP-1050_fast.root
//////////////////////////////////////////////////////////

#ifndef fastsimBranches_h
#define fastsimBranches_h
...
public :
   ...
   fastsimBranches(TTree *tree=0);
   virtual ~fastsimBranches();
...
#ifdef fastsimBranches_cxx
fastsimBranches::fastsimBranches(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data3/store/user/hatake/ntuples/SusyRA2Analysis2015/Run2ProductionV4/scan/T1bbbb_mMother-2000_mLSP-1050_fast.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data3/store/user/hatake/ntuples/SusyRA2Analysis2015/Run2ProductionV4/scan/T1bbbb_mMother-2000_mLSP-1050_fast.root");
      }
...
fastsimBranches::~fastsimBranches()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fastsimBranches::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fastsimBranches::LoadTree(Long64_t entry)
{
...
void fastsimBranches::Init(TTree *tree)
{
...
void fastsimBranches::Show(Long64_t entry)
{
...
Int_t fastsimBranches::Cut(Long64_t entry)
{
...
#endif // #ifdef fastsimBranches_cxx
