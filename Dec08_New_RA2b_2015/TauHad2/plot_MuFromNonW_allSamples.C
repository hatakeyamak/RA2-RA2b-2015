void plot_MuFromNonW_allSamples(string sample="TTbar_"){
...
//  setTDRStyle();
  ...
  sprintf(tempname,"Stack/Probability_Tau_mu_TTbar_stacked.root");
  TFile *file_TTbar   = new TFile(tempname,"R");
  sprintf(tempname,"Stack/Probability_Tau_mu_WJet_stacked.root");
...
//...........................................................................//
    ...
    thist2->GetXaxis()->SetTitle("search bins");
    thist2->GetYaxis()->SetTitle("Probability mu from nonW");
    thist2->GetXaxis()->SetRangeUser(0.,XUp);
    thist2->SetMaximum(maxVal);
...
//    thist->SetLineWidth(3);
    ...
    sprintf(tempname,"ProbabilityNonWMu_allSamples.png");
    c1->Print(tempname);
