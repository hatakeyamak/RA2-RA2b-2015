void plot_Acceptance_allSamples(string sample="TTbar_"){
...
//  setTDRStyle();
  ...
  sprintf(tempname,"Stack/LostLepton2_MuonEfficienciesFromTTbar_stacked.root");
  TFile *file_TTbar   = new TFile(tempname,"R");
  sprintf(tempname,"Stack/LostLepton2_MuonEfficienciesFromWJet_stacked.root");
...
//...........................................................................//
    ...
    thist2->GetXaxis()->SetTitle("mht_#jet bins");
    thist2->GetYaxis()->SetTitle("Acceptance");
    thist2->GetXaxis()->SetRangeUser(0.,XUp);
    thist2->SetMaximum(maxVal);
...
//    thist->SetLineWidth(3);
    ...
    sprintf(tempname,"Acceptance_allSamples.png");
    c1->Print(tempname);
