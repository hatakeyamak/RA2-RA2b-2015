...
#  root -l -b -q Plot_Commissioning_Data.C'("DelPhi3",0)'
   ...
   root -l Plot_Commissioning.C'("HT","delphi",36,true,1)'
   root -l Plot_Commissioning.C'("MHT","delphi",36,true,1)'
   root -l Plot_Commissioning.C'("NJet","delphi",36,true,1)'
   root -l Plot_Commissioning.C'("NBtag","delphi",36,true,1)'
