...
Plot_Commissioning_Data(string histname="MHT",int choice=0){
  ...
  TH1D * hExpTT, * hExpWJ, * hPreTT, * hPre;
  TH1D * histTemplate;
  ...
  hPre  =(TH1D*) Pre->Get(tempname)->Clone();
...
//  hExpWJ->Scale(1/100.);
  ...
  TLatex * ttext = new TLatex(xmin, ymax_top*1.3,"CMS Preliminary, #sqrt{s} = 13 TeV");
