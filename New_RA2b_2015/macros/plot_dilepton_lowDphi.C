...
void plot_dilepton_lowDphi(int IsoModel=0){
...
//  gROOT->LoadMacro("CMS_lumi_v2.C");
  ...
  sprintf(tempname,"InputRootFiles/DileptonRate_TTbar_stacked.root");
  TFile *file_TTbar   = new TFile(tempname,"R");
  sprintf(tempname,"InputRootFiles/DileptonRate_WJet_stacked.root");
  TFile *file_WJet   = new TFile(tempname,"R");
  sprintf(tempname,"InputRootFiles/DileptonRate_stacked.root");
...
// TTbar ....................................................................//
//...........................................................................//
    double XUp = 18. , maxVal=.4;

    sprintf(tempname,"dilepton_rate_lowDphi");
    ...
    thist3->GetYaxis()->SetTitleOffset(1.45);
...
//    thist->SetLineWidth(3);
    ...
    sprintf(tempname,"dilepton_rate_lowDphi.png");
    c1->Print(tempname);
