...
void plot_Acceptance_forAN(std::string elogForPlot="Elog401_"){
  ...
  sprintf(tempname,"TauHad/Stack/%s TauHad/Stack/%sLostLepton2_MuonEfficienciesFromstacked.root",elogForPlot.c_str());
