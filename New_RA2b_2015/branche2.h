...
// Fri May  8 09:40:47 2015 by ROOT version 5.34/25
...
public :
   ...
   Float_t         slimmedElectronsE[7];   //[slimmedElectronsNum]
   Float_t         slimmedElectronsTLorentzVector[7];   //[slimmedElectronsNum]
   vector<double>  *slimmedMuonsPtVec;
   vector<double>  *slimmedMuonsEtaVec;
   vector<double>  *slimmedMuonsPhiVec;
   UShort_t        slimmedMuonsNum;
   Float_t         slimmedMuonsE[13];   //[slimmedMuonsNum]
   Float_t         slimmedMuonsTLorentzVector[13];   //[slimmedMuonsNum]
...
#ifdef branche2_cxx
branche2::branche2(TTree *tree) : fChain(0) 
{
...
Int_t branche2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t branche2::LoadTree(Long64_t entry)
{
...
void branche2::Show(Long64_t entry)
{
...
Int_t branche2::Cut(Long64_t entry)
{
