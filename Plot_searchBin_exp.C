...
void Plot_searchBin_exp(string sample="stacked",string histname="searchH_b",string elogA="Elog410_",string elogB="Elog410_",
			 int pull=0){
...
*/
  ...
  sprintf(tempname,"PlotExp_%s_%s_Full_%s%sPlot.png",histname.c_str(),sample.c_str(),elogA.c_str(),elogB.c_str());
  if (pull==1) 
    sprintf(tempname,"PlotExpPull_%s_%s_Full_%s%sPlot.png",histname.c_str(),sample.c_str(),elogA.c_str(),elogB.c_str());
  canvas->Print(tempname);

  sprintf(tempname,"PlotExp_%s_%s_Full_%s%sPlot.pdf",histname.c_str(),sample.c_str(),elogA.c_str(),elogB.c_str());
  if (pull==1)
    sprintf(tempname,"PlotExpPull_%s_%s_Full_%s%sPlot.pdf",histname.c_str(),sample.c_str(),elogA.c_str(),elogB.c_str());
  canvas->Print(tempname);
