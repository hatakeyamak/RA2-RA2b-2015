...
mainClass(int luminosity=5000){ // luminosity is in /pb unit
  ...
  WJtype[0]="EventsWith_0RecoMuon_0RecoElectron_1tauJet";
  TTbartype[0]="EventsWith_0RecoMuon_0RecoElectron_1tauJet";
...
//..........................................//
  ...
  sprintf(tempname,"GenInfo_HadTauEstimation_WJ_stacked.root");
...
//..........................................//
  ...
  for(int i=1; i<=wjnHT ; i++){
    if(i==1)sprintf(tempname,"HadTau_TauResponseTemplates_WJ_HT-100to200_.root");
    else if(i==2)sprintf(tempname,"HadTau_TauResponseTemplates_WJ_HT-200to400_.root");
    else if(i==3)sprintf(tempname,"HadTau_TauResponseTemplates_WJ_HT-400to600_.root");
    else if(i==4)sprintf(tempname,"HadTau_TauResponseTemplates_WJ_HT-600toInf_.root");
    else{cout << " Error!! There are only 4 WJet ht binned sample " << endl;}
    WJ_inputfilevec.push_back(TFile::Open(tempname,"R"));
  }//end of loop over HTbins 
  ...
  // Stack
  tempstack = new THStack("stack","Binned Sample Stack");
  sprintf(tempname,"HadTau_TauResponseTemplates_WJ_stacked.root");
  file = new TFile(tempname,"RECREATE");
...
//..........................................//
  ...
  for(int i=1; i<=wjnHT ; i++){
    if(i==1)sprintf(tempname,"Probability_Tau_mu_WJ_HT-100to200_.root");
    else if(i==2)sprintf(tempname,"Probability_Tau_mu_WJ_HT-200to400_.root");
    else if(i==3)sprintf(tempname,"Probability_Tau_mu_WJ_HT-400to600_.root");
    else if(i==4)sprintf(tempname,"Probability_Tau_mu_WJ_HT-600toInf_.root");
    else{cout << " Error!! There are only 4 WJet ht binned sample " << endl;}
    WJ_inputfilevec.push_back(TFile::Open(tempname,"R"));
  }//end of loop over HTbins 
  ...
  // Stack
  tempstack = new THStack("stack","Binned Sample Stack");
  sprintf(tempname,"Probability_Tau_mu_WJ_stacked.root");
  file = new TFile(tempname,"RECREATE");
  ...
  file->Close();
  printf("WJ muon from tau probability calculated. \n ");
...
// ..................................................................................................................................................... //
  ...
  for(int i=1; i<=NSamples ; i++){
    ...
    else if(i==2)sprintf(tempname,"GenInfo_HadTauEstimation_WJ_stacked.root");
