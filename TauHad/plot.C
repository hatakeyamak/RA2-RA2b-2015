...
catLeg1->SetTextFont(42);
  ...
  // ratio of histograms before and after isoTrk veto
    ...
    sprintf(tempname,"EventsWith_0RecoMuon_0RecoElectron_1tauJet/delphi/%s_delphi_EventsWith_0RecoMuon_0RecoElectron_1tauJet",histname.c_str() );
    thist = (TH1D *) file->Get(tempname)->Clone();
    sprintf(tempname,"EventsWith_0RecoMuon_0RecoElectron_1tauJet/iso/%s_iso_EventsWith_0RecoMuon_0RecoElectron_1tauJet",histname.c_str() );
   ...
   // catLeg1->Draw();
    sprintf(tempname,"%s_ratioBeforeAfterIsoTrk.pdf",histname.c_str());
    c1->Print(tempname);
